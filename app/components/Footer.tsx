        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-6 md:mb-8">
          ...
          <div>
            ...
            <ul className="space-y-1.5 md:space-y-2">
              <li>
                <Link href="/apostas-esportivas" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Apostas Esportivas
                </Link>
              </li>
              <li>
                <Link href="/esportes-ao-vivo" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Esportes ao Vivo
                </Link>
              </li>
              <li>
                <Link href="/promocoes" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Promoções
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-1.5 md:space-y-2">
              <li>
                <Link href="/termos-e-condicoes" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Termos e Condições
                </Link>
              </li>
              <li>
                <Link href="/politica-de-privacidade" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Política de Privacidade
                </Link>
              </li>
              <li>
                <Link href="/politica-kyc" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Política KYC
                </Link>
              </li>
              <li>
                <Link href="/jogo-responsavel" className="text-gray-400 hover:text-[#d4af37] transition-colors text-sm md:text-base">
                  Jogo Responsável
                </Link>
              </li>
            </ul>
