      ...
      >
        <div className="min-h-full pb-6">
          ...
          <div className="border-b border-[#0d5d4b] px-4 py-3">
            ...
            <button className="w-full bg-[#0d5d4b] border border-[#0a4d3e] rounded-lg px-3 py-2 text-white text-xs flex items-center justify-between hover:bg-[#0f6f5a] transition-all duration-200 hover:border-[#0f6f5a]">
